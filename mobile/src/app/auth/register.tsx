    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Buat Akun GG Tix</Text>
          <Text style={styles.subtitle}>Daftar untuk memesan tiket konser impianmu</Text>
        </View>
        ...
        <View style={styles.form}>
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="person-outline" size={18} color={BRAND_COLORS.muted} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <Ionicons name="shield-checkmark-outline" size={18} color={BRAND_COLORS.muted} style={styles.inputIcon} />
              <TextInput
                style={styles.input}
